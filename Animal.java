...
public class Animal {
	...
	public static final double FAVNUMBER = 10.294;
	...
	public void setFavoriteChar() {
		...
		if ((randomNumber > 97) && (randomNumber < 122)) {
			...
			System.out.println("Favorite charater is a lowercase letter");
		}
		if (((randomNumber > 97) && (randomNumber < 122)) || ((randomNumber > 64) && (randomNumber < 91))) {
			
			System.out.println("Favorite charater is a letter");
		}
		...
		case 8:
			System.out.println("Favortie character set to backspace");
			break;
		}
	}
